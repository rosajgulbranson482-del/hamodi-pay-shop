      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="text-center sm:text-right">
            ...
            <p className="text-primary-foreground/80 text-xs md:text-sm mb-3">
              متجرك الإلكتروني الموثوق لأفضل المنتجات الإلكترونية بأسعار منافسة وتوصيل لجميع محافظات مصر
            </p>
            <a 
              href="https://www.facebook.com/share/16mGAj6vGU/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-primary-foreground/90 hover:text-primary-foreground transition-colors text-xs md:text-sm"
            >
